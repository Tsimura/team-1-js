...
function articles({ poster_path, original_title, release_date, genre_ids }) {
    ...
    return  `<div id="gallery" class="hp__gallery_el">
      ...
      ${poster_path ? `<img class="hp__gallery_img" src="https://image.tmdb.org/t/p/w500${poster_path}" alt="${original_title}"` : `<img class="hp__gallery_img" src="${poster}" alt="Poster is missing"`}></div>
