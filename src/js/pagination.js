...
// // end пагинация paginationSearch.....................................................
// // пагинация paginationSort.....................................................
...
mediaPagination();
// const paginationSort = new Pagination(container, options);
page = paginationSort.getCurrentPage();

paginationSort.on('afterMove', evt => {
  const page = evt.page;
  consol.log(evt.page);
  mediaPagination();
  window.scrollTo({ top: 0, behavior: 'smooth' });
  ...
  setTimeout(() => {
    fetchTrending(page)
      .then(sortAPI(filterYear.value, sortBy.value, genreBtn.value))
      .then(data => {
...
// paginationSort.off(container, evt => {
//   const page = evt.page;
//   consol.log(evt.page);
//   mediaPagination();
//   window.scrollTo({ top: 0, behavior: 'smooth' });
